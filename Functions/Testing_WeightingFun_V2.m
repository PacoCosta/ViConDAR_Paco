...
elseif strcmpi(input.flag_probe_weighting,"gaussian")
    ...
    for ind_points = 1:size(VFinalTotal_TimeInt2,2)
        ...
        interval_of_confidence = input.truncation_val*input.distance_av_space; % Taken from literature (see "Comparison of methods to derive radial wind speed from a continuous-wave coherent lidar Doppler spectrum"  Held D. and Mann J. - 2018)
